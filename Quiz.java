...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String username){
        ...
        next.setBounds(1100, 520, 200, 35);
        add(next);
        ...
        lifeline.setBounds(1100, 590, 200, 35);
        add(lifeline);
        ...
        submit.setBounds(1100, 660, 200, 35);
        add(submit);
